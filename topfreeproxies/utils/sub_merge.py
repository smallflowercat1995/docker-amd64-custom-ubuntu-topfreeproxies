...
class merge():
    ...
    def sub_merge(self): # 将转换后的所有 Url 链接内容合并转换 YAML or Base64, ，并输出文件，输入订阅列表。
        ...
        content_mihomo = convert(''.join(content_list),'clash_provider',self.format_config)
        ...
        def content_write(file, output_type):
            ...
            file.close
        write_list = [f'{merge_dir}/sub_merge.txt', f'{merge_dir}/sub_merge_base64.txt', f'{merge_dir}/sub_merge_mihomo.yaml']
        content_type = (content, content_base64, content_mihomo)
